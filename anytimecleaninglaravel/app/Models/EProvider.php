...
class EProvider extends Model implements HasMedia, Castable
{
    ...
    {
        if (Module::isActivated('Subscription'))
            return $this->hasMany('Modules\Subscription\Models\EProviderSubscription', 'user_id');
        else
    ...
    {
        return $this->belongsToMany(EService::class, 'service_provides', 'provider_id', 'service_id');
    }
