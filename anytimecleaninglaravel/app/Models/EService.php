...
class EService extends Model implements HasMedia, Castable
{
    ...
    public function scopeNear($query, $latitude, $longitude)
    {
        ...
        return $query
            ->join('e_providers', 'e_providers.id', '=', 'e_services.user_id')
            ->join('e_provider_addresses', 'e_provider_addresses.user_id', '=', 'e_services.user_id')
    ...
    {
        return $this->belongsTo(User::class, 'user_id', 'id')->with('media');
    }
    ...
    // {
    //     return $this->belongsToMany(EProvider::class, 'service_provides', 'service_id', 'provider_id');
    // }

    public function providers()
    {
        return $this->belongsToMany(User::class, 'service_provides');
        // return $this->belongsToMany(User::class, 'service_provides', 'e_service_id', 'user_id');
