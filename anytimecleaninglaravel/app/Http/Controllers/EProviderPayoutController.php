...
class EProviderPayoutController extends Controller
{
    ...
    public function create(int $id)
    {
        ...
        $earning = $this->earningRepository->findByField('user_id', $id)->first();
        $totalPayout = $this->eProviderPayoutRepository->findByField('user_id', $id)->sum("amount");
    ...
    {
        $input = $request->all();
        $earning = $this->earningRepository->findByField('user_id', $input['user_id'])->first();
        $totalPayout = $this->eProviderPayoutRepository->findByField('user_id', $input['user_id'])->sum("amount");
