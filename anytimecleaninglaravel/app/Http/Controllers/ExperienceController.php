...
class ExperienceController extends Controller
{
    ...
    public function __construct(ExperienceRepository $experienceRepo, CustomFieldRepository $customFieldRepo, UserRepository $eProviderRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        $current_provider = auth()->user();
        return view('experiences.create')->with("customFields", isset($html) ? $html : false)->with("eProvider", $eProvider)->with("current_provider", $current_provider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('experiences.edit')->with('experience', $experience)->with("customFields", isset($html) ? $html : false)->with("eProvider", $eProvider)->with("current_provider", $current_provider);
    }
