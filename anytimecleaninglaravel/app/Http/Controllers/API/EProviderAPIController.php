...
class EProviderAPIController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        // }
        $eProviders = User::where('accepted','1')->with('roles')->whereHas('roles', function($query) {
            $query->where('name', 'provider');
        })->get();

        return $this->sendResponse($eProviders, 'E Providers retrieved successfully');
    }
