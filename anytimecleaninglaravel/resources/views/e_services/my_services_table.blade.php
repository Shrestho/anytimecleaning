            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @can('show.in_provider')
                        <li class="nav-item">
                            <a class="nav-link active" href="{!! route('eServices.my_services_table') !!}"><i class="fa fa-list mr-2"></i>My Services</a>
                        </li>
                    @endcan
                    @can('eServices.provider_create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('eServices.provider_create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.e_service_create')}}
                            </a>
                        </li>
                    @endcan
                </ul>
