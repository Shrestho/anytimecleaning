...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- E Provider Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('user_id', trans("lang.experience_e_provider_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
        {!! Form::text('user_id', $current_provider->name,  ['class' => 'form-control','placeholder'=>  trans("lang.experience_title_placeholder"), 'disabled' => 'disabled']) !!}
