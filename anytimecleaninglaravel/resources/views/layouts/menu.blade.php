...
{{--@can('entries.index')--}}
<li class="nav-item has-treeview {{ Request::is('entries*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('entries*')? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-envelope"></i>@endif
    ...
    @can('entries.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('entries*') ? 'active' : '' }}" href="{!! route('entries.index') !!}">@if($icons)
            <i class="nav-icon fas fa-envelope"></i>@endif<p>Quotation</p></a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('estimates*') ? 'active' : '' }}" href="{!! route('estimates.index') !!}">@if($icons)
            <i class="nav-icon fas fa-envelope"></i>@endif<p>Estimates</p></a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('contacts*') ? 'active' : '' }}" href="{!! route('contacts.index') !!}">@if($icons)
            <i class="nav-icon fas fa-envelope"></i>@endif<p>Contacts</p></a>
        </li>
    @endcan
    </ul>
</li>
