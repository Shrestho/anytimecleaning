...
<li class="nav-item has-treeview <?php echo e(Request::is('entries*') ? 'menu-open' : ''); ?>">
    <a href="#" class="nav-link <?php echo e(Request::is('entries*')? 'active' : ''); ?>"> <?php if($icons): ?>
            <i class="nav-icon fas fa-envelope"></i><?php endif; ?>
        <p>Coming From Frontend<i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('entries.index')): ?>
        <li class="nav-item">
            <a class="nav-link <?php echo e(Request::is('entries*') ? 'active' : ''); ?>" href="<?php echo route('entries.index'); ?>"><?php if($icons): ?>
            <i class="nav-icon fas fa-envelope"></i><?php endif; ?><p>Quotation</p></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e(Request::is('estimates*') ? 'active' : ''); ?>" href="<?php echo route('estimates.index'); ?>"><?php if($icons): ?>
            <i class="nav-icon fas fa-envelope"></i><?php endif; ?><p>Estimates</p></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e(Request::is('contacts*') ? 'active' : ''); ?>" href="<?php echo route('contacts.index'); ?>"><?php if($icons): ?>
            <i class="nav-icon fas fa-envelope"></i><?php endif; ?><p>Contacts</p></a>
        </li>
    <?php endif; ?>
    </ul>
</li>
...
<?php /**PATH F:\xampp\htdocs\anytimecleaninglaravel\resources\views/layouts/menu.blade.php ENDPATH**/ ?>