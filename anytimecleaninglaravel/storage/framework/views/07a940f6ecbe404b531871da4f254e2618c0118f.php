...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold"><?php echo e(trans('lang.notification_plural')); ?>

                        <small class="mx-3">|</small><small><?php echo e(trans('lang.notification_desc')); ?></small>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-md-row flex-column-reverse align-items-start card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fas fa-list mr-2"></i><?php echo e(trans('lang.notification_table')); ?></a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notifications.create')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo route('notifications.create'); ?>"><i class="fas fa-plus mr-2"></i><?php echo e(trans('lang.notification_create')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\anytimecleaninglaravel\resources\views/notifications/index.blade.php ENDPATH**/ ?>