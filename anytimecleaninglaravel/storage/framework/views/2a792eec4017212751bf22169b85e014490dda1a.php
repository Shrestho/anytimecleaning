...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><?php echo trans('lang.media_title'); ?> <small><?php echo e(trans('lang.media_desc')); ?></small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div id="mediaModal" class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fas fa-list mr-2"></i><?php echo e(trans('lang.media_table')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="createMedia"><i class="fas fa-plus mr-2"></i><?php echo e(trans('lang.media_create')); ?></a>
                    </li>
                    <div class="ml-auto d-inline-flex">
                        ...
                        <li class="nav-item">
                            <a class="nav-link pt-1 pb-35" id="refreshMedia" href="#"><i class="fas fa-redo-alt"></i> <?php echo e(trans('lang.refresh')); ?></a>
                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\cleanany\resources\views/medias/index.blade.php ENDPATH**/ ?>