                ...
                <div class="col-md-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo route('bookings.index'); ?>"><?php echo e(trans('lang.booking_plural')); ?></a>
                        </li>
                        <li class="breadcrumb-item active"><?php echo e(trans('lang.booking_edit')); ?></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bookings.index')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo route('bookings.index'); ?>"><i class="fas fa-list mr-2"></i><?php echo e(trans('lang.booking_table')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bookings.show')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo route('bookings.show',$booking->id); ?>"><i class="fas fa-calendar-check mr-2"></i><?php echo e(trans('lang.booking_details')); ?>

                            </a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fas fa-edit mr-2"></i><?php echo e(trans('lang.booking_edit')); ?></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <?php echo Form::model($booking, ['route' => ['bookings.update', $booking->id], 'method' => 'patch']); ?>

                <div class="row">
                    <?php echo $__env->make('bookings.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\anytimecleaninglaravel\resources\views/bookings/edit.blade.php ENDPATH**/ ?>