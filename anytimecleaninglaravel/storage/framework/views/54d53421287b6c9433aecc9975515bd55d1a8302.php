...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold"><?php echo e(trans('lang.coupon_plural')); ?><small class="mx-3">|</small><small><?php echo e(trans('lang.coupon_desc')); ?></small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupons.index')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo route('coupons.index'); ?>"><i class="fas fa-list mr-2"></i><?php echo e(trans('lang.coupon_table')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupons.create')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo route('coupons.create'); ?>"><i class="fas fa-plus mr-2"></i><?php echo e(trans('lang.coupon_create')); ?></a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fas fa-pencil mr-2"></i><?php echo e(trans('lang.coupon_edit')); ?></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <?php echo Form::model($coupon, ['route' => ['coupons.update', $coupon->id], 'method' => 'patch']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\anytimecleaninglaravel\resources\views/coupons/edit.blade.php ENDPATH**/ ?>