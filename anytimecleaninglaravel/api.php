...
Route::get('category_services/{id}', 'API\EServiceAPIController@category_services');
...
Route::post('quotes', 'API\EntryController@store');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('payment', 'API\PaymentAPIController@payment');
    // create payment intent
    Route::post('/create-payment-intent', 'API\PaymentAPIController@createPaymentIntent');
